        ...
        for imgnum in imgnums:
            ...
            if os.path.exists(os.path.join(img_dir, imgname)):
                ...
                for z, line in enumerate(lines):
                    ...
                    while True:
                        print("+--------------------------------------------------")        
                        print('| 5 ： Everything reads fine.')
                        print('| 4 ： Generally readable, but some text is difficult to read')
                        print('| 3 ： Some letters are unreadable.')
                        print('| 2 ： Most of them are unreadable.')
                        print("| 1 ： I can't read at all")
                        print("+--------------------------------------------------")        
